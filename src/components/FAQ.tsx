...
const FAQ: React.FC = () => {
    return (
        <section id="faq" className="py-10 lg:py-20 mt-24">
            <div className="flex flex-col lg:flex-row gap-10">
                <div className="">
                    ...
                    <a href="mailto:modelnavigator@essential-soft.com" className="mt-3 block text-xl lg:text-2xl text-secondary font-semibold hover:underline text-center lg:text-left">modelnavigator@essential-soft.com</a>
                </div>
